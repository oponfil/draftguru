...
def record_video_recognition() -> None:
    """Записывает успешное распознавание видео."""
    _stats.video_recognitions += 1
...
def get_stats() -> dict[str, Any]:
    ...
    return {
        ...
        "video_recognitions": _stats.video_recognitions,
        # Команды
