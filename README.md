...
| **Style** (🦉/🍻/💕/💼/💰/🕵️/😈) | Стиль общения: Под пользователя, Друг Гуру, Гуру Романтики, Деловой Гуру, Продавец Гуру, Гуру Параноик, Гуру Соблазнения. Определяет тон и манеру ответов (в том числе при общении напрямую с ботом). | 🦉 Userlike |
