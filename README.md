...
- **handlers/** — Обработчики команд (`bot_handlers.py` — `/start`, `on_text`; `settings_handler.py` — `/settings`; `styles_handler.py` — `/chats`) и событий Pyrogram (`pyrogram_handlers.py` — `/connect`, `on_pyrogram_message`, `on_pyrogram_draft`)
