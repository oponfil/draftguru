...
- `VOICE_TRANSCRIPTION_TIMEOUT` — таймаут ожидания транскрипции голосового (секунды, по умолчанию `60`)
...
| **Auto-reply** (⏰) | Таймер автоответа. Если пользователь не отправил черновик за указанное время, бот отправляет сообщение сам. Варианты: OFF, 1 мин, 5 мин, 15 мин, 1 час, 24 часа. Реальная задержка рандомизирована (от base до 2×base). | OFF |
